...
let activeQueue = [];   // Menyimpan daftar ID lagu yang sedang antri (misal: lagu favorit)
let isQueueActive = false; // Penanda apakah kita sedang memutar dari mode antrian
...
const song_num = 16; // 0..16

const PLAYLISTS = ["Lagu Indonesia", "Lagu Inggris"];

const TRACKS = [
    {
        "playlist": "Lagu Indonesia",
    ...
    },
    {
        ...
        "cover": "armada_pergi_pulang_pagi.jpeg",
    ...
    },
    {
        ...
        "artist": "Afgan",
        "cover": "afgan_jodoh_pasti_bertemu.jpeg",
        "audio": "./audios/song5.mp3",
        "id": 5
    },
    {
        "playlist": "Lagu Indonesia",
        ...
        "cover": "anugerah_terindah.jpeg",
        "audio": "./audios/song6.mp3",
        "id": 6
    },
    {
        "playlist": "Lagu Indonesia",
        ...
        "artist": "Andmesh Kamelang",
        "cover": "andmesh_cinta_luar_biasa.jpeg",
        "audio": "./audios/song7.mp3",
        "id": 7
    },
    {
        "playlist": "Lagu Indonesia",
        ...
        "cover": "hanya_rindu.jpeg",
        "audio": "./audios/song8.mp3",
        "id": 8
    },
    {
        "playlist": "Lagu Indonesia",
    ...
    },
    {
        ...
        "artist": "Armada",
        "cover": "apa_kabar_sayang.jpeg",
        "audio": "./audios/song10.mp3",
        "id": 10
    },
    {
        "playlist": "Lagu Indonesia",
    ...
    },
    {
        ...
        "title": "Buka Hatimu",
        "artist": "Armada",
        "cover": "buka_hatimu.jpeg",
        "audio": "./audios/song12.mp3",
        "id": 12
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Kangen",
        "artist": "Dewa 19",
        "cover": "kangen_dewa.jpeg",
        "audio": "./audios/song13.mp3",
        "id": 13
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Separuh Nafas",
        "artist": "Dewa 19",
        "cover": "separuh_nafas.jpeg",
        "audio": "./audios/song14.mp3",
        "id": 14
    },
    {
        "playlist": "Lagu Indonesia",
    ...
    },
    {
        ...
        "title": "Kehilangan",
        "artist": "firman",
        "cover": "kehilangan.jpeg",
        "audio": "./audios/song17.mp3",
        "id": 17
    },
    {
        "playlist": "Lagu Indonesia",
    ...
    },
    {
        ...
        "artist": "Hindia",
        "cover": "everything.jpeg",
        "audio": "./audios/song19.mp3",
        "id": 19
    },
    {
        "playlist": "Lagu Indonesia",
    ...
    },
    {
        ...
        "title": "Secukupnya",
        "artist": "Hindia",
        "cover": "secukupnya.jpeg",
        "audio": "./audios/song21.mp3",
        "id": 21
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Pujaan Hati",
        "artist": "Kangen Band",
        "cover": "pujaan_hati.jpeg",
        "audio": "./audios/song22.mp3",
        "id": 22
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Cinta Yang Sempurna",
        "artist": "Kangen Band",
        "cover": "cinta_yang_sempurna.jpeg",
        "audio": "./audios/song23.mp3",
        "id": 23
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Masih Mencintainya",
        "artist": "Papinka",
        "cover": "masih_mencintainya.jpeg",
        "audio": "./audios/song24.mp3",
        "id": 24
    },
    {
        "playlist": "Lagu Indonesia",
        ...
        "cover": "penjaga_hati.jpeg",
        "audio": "./audios/song25.mp3",
        "id": 25
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Separuh Aku",
        "artist": "NOAH",
        "cover": "separuh_aku.jpeg",
        "audio": "./audios/song26.mp3",
        "id": 26
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Diamana Hatimu",
        "artist": "PAPINKA",
        "cover": "dimana_hatimu.jpeg",
        "audio": "./audios/song27.mp3",
        "id": 27
    },
    {
        "playlist": "Lagu Indonesia",
        ...
        "artist": "Peterpan",
        "cover": "ada_apa_denganmu.jpeg",
        "audio": "./audios/song28.mp3",
        "id": 28
    },
    {
        "playlist": "Lagu Indonesia",
        ...
        "artist": "Peterpan",
        "cover": "mimpi_yang_sempurna.jpeg",
        "audio": "./audios/song29.mp3",
        "id": 29
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Mungkin Nanti",
        "artist": "Peterpan",
        "cover": "mungkin_nanti.jpeg",
        "audio": "./audios/song30.mp3",
        "id": 30
    },
    {
        "playlist": "Lagu Indonesia",
    ...
    },
    {
        ...
        "artist": "Samsons",
        "cover": "kenangan_terindah.jpg",
        "audio": "./audios/song32.mp3",
        "id": 32
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Aku Masih Sayang",
        "artist": "ST 12",
        "cover": "aku_masih_sayang.jpg",
        "audio": "./audios/song33.mp3",
        "id": 33
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Putri Iklan",
        "artist": "ST 12",
        "cover": "putri_iklan.jpg",
        "audio": "./audios/song34.mp3",
        "id": 34
    },
    {
        "playlist": "Lagu Indonesia",
        ...
        "artist": "ST 12",
        "cover": "rasa_yang_tertinggal.jpg",
        "audio": "./audios/song35.mp3",
        "id": 35
    },
    {
        "playlist": "Lagu Indonesia",
    ...
    },
    {
        ...
        "title": "Aishiteru 1",
        "artist": "Zilivia",
        "cover": "aishiteru1.jpg",
        "audio": "./audios/song37.mp3",
        "id": 37
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Aishiteru 2",
        "artist": "Zilivia",
        "cover": "aishiteru2.jpg",
        "audio": "./audios/song38.mp3",
        "id": 38
    },
    {
        "playlist": "Lagu Indonesia",
        "title": "Aishiteru 3",
        "artist": "Zilivia",
        "cover": "aishiteru3.jpg",
        "audio": "./audios/song39.mp3",
        "id": 39
    },
    {
        "playlist": "Lagu Inggris",
        "title": "The Winner Takes It All",
        "artist": "ABBA",
        "cover": "abba.jpg",
        "audio": "./audios/song40.mp3",
        "id": 40
    },
    {
        "playlist": "Lagu Inggris",
...
const validateUsername = (username) => {
    if (username.length < USERNAME_MIN_LENGTH) {
        createErrorMessage(`Pengguna harus memiliki setidaknya ${USERNAME_MIN_LENGTH} karakter`)
        return false;
    }
    return true;
}
...
const validatePassword = (password) => {
    if (password.length < PASSWORD_MIN_LENGTH) {
        createErrorMessage(`Kata Sandi harus minimal ${PASSWORD_MIN_LENGTH} Karakter`)
        return false;
    }
    return true;
}
...
const validateEmail = (email) =>{
    ...
    if (regex.test(email) == true){
      return true;
        ...
        createErrorMessage(`email harus seperti berikut <example@gmail.com>`)
      return false
    }
  }
...
const login = (event) => {
    ...
    if (user.username === username && user.password === password) {
        ...
        createErrorMessage("Username / Password Salah");
    }
}
...
const setNavbarLinks = () => {
    ...
    if (isAuthenticated === "true") {
                    ...
                    <div class="navbar-profile-option-container">
                        <div class="navbar-profile-option">
                            ...
                            <a href="#settings" class="navbar-profile-option-link" onclick="goToAccount()">
                                <p class="navbar-profile-option-text">Edit Profil</p>
                            </a>
                        </div>
                        <div class="navbar-profile-option">
                            ...
                            <a class="navbar-profile-option-link" onclick="goToProfile()">
                                <p class="navbar-profile-option-text">Profil Anda</p>
                            </a>
                        </div>
                        ...
                        <div class="navbar-profile-option">
                            ...
                            <a href="#logout" class="navbar-profile-option-link" onclick="modalFunction()">
                                <p class="navbar-profile-option-text">Keluar</p>
                            </a>
                        </div>
                    </div>
                </div>
        ...
        const songsSearchbar = `
            ...
            <div class="searchbar-container">
                ...
                <input id="searchbar" onkeyup="searchSong()" class="searchbar" type="text" placeholder="Pencarian">
    ...
    if (isAuthenticated === "true" && window.location.href.includes("profile.html")) {
        ...
        const userProfileInitialData = `
            ...
            <p id="profile-extra-title">Artis yang digemari</p>
            ...
            <p id="profile-extra-title">Musik</p>
            <div class="profile-extra-artists" id="profile-extra-artists">
            ...
            <p id="profile-extra-title">Lagu Pavorite</p>
        `;
        ...
        const restOfSections = `
            <p id="profile-extra-title">Musik : 1</p>
                <div class="profile-extra-artists" id="profile-extra-artists">
                <div class="song-container">
                ...
                <p id="profile-extra-title">Artis</p>
                <div class="profile-extra-artists" id="profile-extra-artists">
                    <div class="artist-profile">
    ...
    if (window.location.href.includes("artist.html")) {
        ...
        <div class="profile-extra">
            ...
            <p id="profile-extra-title">Judika Simpang Jodoh</p>
    ...
    if (isAuthenticated === "true" && window.location.href.includes("follower.html")) {
        ...
        <hr>
        <div class="profile-extra">
            <p id="profile-extra-title">Artis Lainnya</p>
            <div class="profile-extra-artists" id="profile-extra-artists">
                <div class="artist-profile">
                ...
                <div class="artist-profile">
                    <img src="images/david_guetta.jpeg" alt="artist2" class="artist-img">
                    <p class="artist-name">David Guetta</p>
                </div>
                <div class="artist-profile">
                    <img src="images/50cent.jpeg" alt="artist3" class="artist-img" >
                    <p class="artist-name">Sheila On 8</p>
                </div>
            </div>
            <p id="profile-extra-title">Lagu Populer</p>
            <div class="profile-extra-artists" id="profile-extra-artists">
            <div class="artist-profile">
            ...
            <p id="profile-extra-title">Lagu Favorit</p>
    ...
    if (isAuthenticated === "true" && window.location.href.includes("account.html")) {
        ...
        form.innerHTML = `
            <p class="profile-data-title">Username Anda</p>
            <label for="username" class="hidden">Username</label>
            <input class="profile-data-info" type="text" name="username" id="username" placeholder="Username Anda" value="${username}">
            <p class="profile-data-title">Email Anda</p>
            <label for="email" class="hidden">Email</label>
            <input class="profile-data-info" type="email" name="email" id="email" placeholder="Email Anda" value="${email}">
...
const setPlaylistsInHome = () => {
    ...
    if (isAuthenticated !== "true") {
        ...
        <h2 class="music-genre-title">Baru ditambahkan</h2>
<div class="music-genre-songs-container">

    <div class="song-container">
        <figure class="song-cover-container">
            <img class="song-cover" src="./images/lyodra.jpeg" alt="Song Cover">
            <a id="play-icon" onclick="openMusicPlayer(8)"></a>
        </figure>
        <p class="song-description">Teganya Kau</p>
        <a class="song-author">Lyodra</a>
        <p id="counter-0"></p>
    </div>

    <div class="song-container">
        <figure class="song-cover-container">
            <img class="song-cover" src="./images/samsons.jpeg" alt="Song Cover">
            <a id="play-icon" onclick="openMusicPlayer(10)"></a>
        </figure>
        <p class="song-description">Tentang Kita</p>
        <a class="song-author">Samsons</a>
        <p id="counter-1"></p>
    </div>

    <div class="song-container">
        <figure class="song-cover-container">
            <img class="song-cover" src="./images/tiara.jpeg" alt="Song Cover">
            <a id="play-icon" onclick="openMusicPlayer(14)"></a>
        </figure>
        <p class="song-description">Dengar</p>
        <a class="song-author">Tiara Andini</a>
        <p id="counter-2"></p>
    </div>

    <div class="song-container">
        <figure class="song-cover-container">
            <img class="song-cover" src="./images/rizky.jpeg" alt="Song Cover">
            <a id="play-icon" onclick="openMusicPlayer(14)"></a>
        </figure>
        <p class="song-description">Alamak</p>
        <a class="song-author">Rizky Febian</a>
        <p id="counter-2"></p>
    </div>
    ...
    songsGroupedByPlaylist.forEach((songsGroupedByPlaylist) => {
        ...
        songs.forEach((song) => {
            ...
            `;
            if(isAuthenticated === "true"){
    // 1. Ambil ikon status saat ini (hati penuh atau kosong)
    const likedIcon = getLikeDisplayIcon(title);
    
    // 2. Buat elemen HTML TANPA 'onClick' di dalamnya. Kita pakai JavaScript murni agar rapi.
    // Tambahkan style cursor: pointer agar terlihat bisa diklik
    const likedIconElement = `<img src="${likedIcon}" alt="Liked Icon" class="liked-icon" style="cursor: pointer;">`;
    
    const likedContainer = musicCard.querySelector(".liked-container");
    likedContainer.innerHTML = likedIconElement;
    
    // 3. Ambil elemen gambar yang baru saja dibuat
    const likedImage = musicCard.querySelector(".liked-icon");
    
    // 4. Tambahkan fungsi klik yang benar
    likedImage.addEventListener("click", () => {
        // A. Simpan atau Hapus lagu dari localStorage
        toggleLike(title);
        
        // B. Cek ulang status ikon terbaru setelah data disimpan
        const newIcon = getLikeDisplayIcon(title);
        
        // C. Update gambar ikon hati
        likedImage.src = newIcon;
    });
}
...
function closeMusicPlayer () {
    ...
    // vvvvv LOGIKA MEMUNCULKAN FOOTER KEMBALI vvvvv
    const isAuthenticated = localStorage.getItem("isAuthenticated");

    // Jika user BELUM login (isAuthenticated bukan "true")
    if (isAuthenticated !== "true") {
        const footer = document.getElementsByClassName("cta-container");
        const footerText = document.getElementsByClassName("cta-text");
        
        // Paksa footer muncul kembali dengan display flex/block
        if (footer.length > 0) {
            footer[0].style.display = "flex"; 
        }
        if (footerText.length > 0) {
            footerText[0].style.display = "block";
        }
    }
}
...
// Clear the previous seek timer
    clearInterval(updateTimer); // <-- Hentikan timer lagu sebelumnya
    resetValues();
    ...
    // --- UBAH BAGIAN INI ---
    // Logika: Apa yang terjadi saat lagu selesai?
    curr_track.addEventListener("ended", () => {
        const isAuthenticated = localStorage.getItem("isAuthenticated");

        // Jika user BELUM Login -> Tutup player & Tampilkan Footer
        if (isAuthenticated !== "true") {
            closeMusicPlayer(); 
        } 
        // Jika user SUDAH Login -> Lanjut ke lagu berikutnya
        else {
            nextTrack();
        }
    });
...
function setVolume() {
    ...
    curr_track.volume = volumeSlider.value / 500;
}
...
const createLikedSongs = () => {
    ...
    if (isAuthenticated === "false") {
        ...
        myListsContainer.innerHTML = `
            <p class="music-genre-title">Lagu Yang Kamu Sukai Akan Muncul Disini</p>
            <button onClick="goToLogin()" class="btn-default">Login</button>
        `;
    } else {
        const playlistContainer = document.createElement("div");
        playlistContainer.classList.add("music-genre-container");
        ...
        if (playlistSongs.length == 0) {
            if (myListsContainer != null) {
                myListsContainer.innerHTML = `
                    <h2 class="music-genre-title">Lagu Yang Kamu Sukai Akan Muncul Disini</h2>
                `;
            }
        } else {
            var iterador = 0;
...
const createMyLists = () => {
    ...
    if (isAuthenticated === "true") {
        ...
        if (playlists.length == 0) {
            myListsContainer.innerHTML = `
                <h2 class="music-genre-title">Belum Ada List</h2>
                <button onClick="goToPlaylistCreator()" class="btn-default">Buat List</button>
            `;
        } else {
            playlists.forEach((playlist) => {
                ...
                playlistContainer.classList.add("music-genre-container");
                playlistContainer.innerHTML = `
                    <h2 class="music-genre-title">${playlistName}&nbsp;&nbsp;</h2><h3 class="delete-playlist">Hapus</h3>
                    <br><br><br>
                    <div class="music-genre-songs-container">
                    </div>`;
        ...
        if (myListsContainer != null) {
            myListsContainer.innerHTML = `
                <h2 class="music-genre-title">Anda harus masuk untuk membuat daftar Anda sendiri</h2>
                <button onClick="goToLogin()" class="btn-default">Login</button>
            `;
        }
    }
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    setNavbarLinks(); // Penting: Ini membuat elemen searchbar di HTML
    setPlaylistsInHome();
    ...
    // --- KODE SCROLL KEYBOARD (DIPERBAIKI) ---

    // Fungsi pembantu untuk scroll
    const attachScrollListener = (inputId, resultsId) => {
        const inputElement = document.getElementById(inputId);
        const resultsElement = document.getElementById(resultsId);

        if (inputElement && resultsElement) {
            inputElement.addEventListener("keydown", (event) => {
                const scrollAmount = 200; // Pixel scroll per tekanan tombol
                
                if (event.key === "PageDown") {
                    event.preventDefault(); // Cegah kursor teks pindah
                    resultsElement.scrollBy({ top: scrollAmount, behavior: 'smooth' });
    ...
    // 1. Terapkan ke Search Bar Utama (Navbar) -> Sesuai gambar Anda
    // Note: ID input adalah "searchbar", ID hasil adalah "searchbar-results"
    attachScrollListener("searchbar", "searchbar-results");

    // 2. Terapkan ke Playlist Creator (Opsional, jaga-jaga)
    attachScrollListener("playlist-creator-searchbar", "playlist-creator-results");
    
    // Pastikan fungsi pencarian playlist creator tetap berjalan
    const playlistSearchInput = document.getElementById("playlist-creator-searchbar");
    if (playlistSearchInput) {
        playlistSearchInput.addEventListener("keyup", searchSongForPlaylist);
    }
});
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (loginForm) {
        loginForm.addEventListener("submit", async (e) => {
            ...
            if (result.success) {
                errorBox.innerHTML = `<p style="color:green">Login Berhasil!</p>`;
                window.location.href = "index.html"; // pindah ke home
            } else {
                errorBox.innerHTML = `<p style="color:red">${result.message}</p>`;
            }
        });
    }
});
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (signupForm) {
        signupForm.addEventListener("submit", async (e) => {
            ...
            if (result.success) {
                errorBox.innerHTML = `<p style="color:green">Registrasi Berhasil!</p>`;
                setTimeout(() => {
                    window.location.href = "login.html";
                }, 1000);
            } else {
...
const form = document.getElementById("playlist-creator-form");
...
form.addEventListener("submit", function (e) {
  e.preventDefault(); // ⛔ STOP POST ke HTML

  if (!allowSubmit) {
    overlay.classList.add("show"); // tampilkan feedback
    return;
  }

  // KIRIM KE SERVER (BENAR)
  ...
  .then(res => res.json())
  .then(data => {
    console.log("Playlist tersimpan");
  });
});
...
okBtn.addEventListener("click", function () {
  ...
  form.requestSubmit(); // lanjut submit
